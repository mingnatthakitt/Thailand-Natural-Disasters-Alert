    ...
    <div className="flex flex-col h-screen w-screen overflow-hidden" style={{ background: 'var(--background)' }}>
      ...
      <div className="flex flex-1 overflow-hidden relative">
        ...
        <main className="flex-1 relative">
          ...
          {/* UI overlay layer — sits above the map, not inside Leaflet's stacking context */}
          <div className="absolute inset-0 pointer-events-none z-10">
            ...
            {/* Region info */}
            <div className="absolute top-4 right-4 region-overlay pointer-events-none">
            ...
            {/* Legend */}
            <div className="absolute bottom-4 left-4 glass-panel rounded-lg px-3 py-2.5 space-y-1.5 pointer-events-none">
          ...
          {loading && events.length === 0 && (
            <div className="absolute inset-0 flex items-center justify-center bg-[#0B0D13]/80 z-30 pointer-events-auto">
